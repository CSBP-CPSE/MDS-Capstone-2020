...
```{r}
library(betareg)
beta_model <- betareg(TOTAL_prop~Arthritis..15.years.and.over.+Body.mass.index..adjusted.self.reported..adult..18.years.and.over...obese+Heavy.drinking+amenity,data = final_cases, link = "loglog")
summary(beta_model)
