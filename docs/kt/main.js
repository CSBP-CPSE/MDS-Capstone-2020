...
// Load the features from the GeoJSON.
d3.json('https://ubco-mds-2019-labs.github.io/data-599-capstone-statistics-canada/kt/data/reversed_LHIN.json', function(error, collection) {
	// console.log(collection.features)
	var features = collection.features;

			d3.csv("https://ubco-mds-2019-labs.github.io/data-599-capstone-statistics-canada/kt/data/ltc_points.csv", function(csv) {
				console.log(csv)
						map4.features = features;
						map4.data = csv;
	 				   ...
	 				   .on('mousemove',  function(f, i){ // show tooltip
	 						 ...
	 						 var meta = map.index[id];
	 							...
	 							.html(meta.ENG_LABEL + "</br> "
										+ "Incidence Rate: " + meta.TOTAL_prop + "</br> "
										// + "Fatalities: " + meta.FATAL + "</br> "
										+ "Case-Fatality Ratio: " + meta.fatality_ratio + "</br> "
