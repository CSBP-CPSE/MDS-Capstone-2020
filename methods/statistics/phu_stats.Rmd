...
#drop gender cols...
df <- subset(df, select = -c(Location, MALEprop, FEMALEprop, TRANSGENDERprop, OTHERprop, UNKNOWNprop, NEITHERprop, hbp.prop))
...
test_logs2 <- lm(log_df$TOTALprop ~.-log_df$hbp.prop, log_df)
plot(test_logs2)
summary(test_logs2)
