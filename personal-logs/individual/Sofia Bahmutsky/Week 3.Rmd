...
4. Trying to find a method to count the db's which do not fall easily into a particular PHU. Checking is there are DB's which overlap into 2 or more PHu's. (3?)

5. Fixing the github...it was broken becuase I tried to push files which were too large.
